...
let h=read('app.html');
h=h.replace(/assets\/js\/ms-food-photo-v1018-1\.js\?v=\d+/,'assets/js/ms-food-photo-v1018-1.js?v=101810');
h=h.replace(/assets\/js\/ms-food-photo-result-v10182\.js\?v=\d+/,'assets/js/ms-food-photo-result-v10182.js?v=101810');
h=h.replace(/assets\/js\/pwa\.js\?v=\d+/,'assets/js/pwa.js?v=101810');
write('app.html',h);
let p=read('assets/js/pwa.js');
p=p.replace(/const VERSION='\d+';/,"const VERSION='101810';");
write('assets/js/pwa.js',p);
console.log('V101810_SIMPLE_UI_PATCH_OK');
